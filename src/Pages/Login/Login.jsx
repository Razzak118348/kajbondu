...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition duration-300 p-4">
      <Helmet>
        <title>Login | kajBondu</title>
      </Helmet>
      <ToastContainer autoClose={500} />

      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 overflow-hidden min-h-[80vh]">
        {/* Left Side - Form */}
        ...
        <div className="hidden md:flex items-center justify-center bg-gray-50 dark:bg-gray-900 h-full">
          <img
            src="https://github.com/Razzak118348/CraftedCanvas_Image/raw/main/images/form.png"
